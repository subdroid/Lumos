...
fairseq-train \
    data-bin/READ_1020 \
    --arch perceiver_deep_encoder \
    --log-file perceiver_deep_log_READ_1020.log --tensorboard-logdir perceiver_deep_1020_READ \
    ...
    --save-dir perceiver_deep_1020_READ \
...
fairseq-train \
    ...
    --arch perceiver_deep_encoder \
    --log-file perceiver_deep_log_REVERSE_1020.log --tensorboard-logdir perceiver_deep_1020_REVERSE \
    --seed 1314 --max-tokens 4096 --find-unused-parameters \
    --optimizer adam --adam-betas '(0.9, 0.98)' --clip-norm 1.0 \
    --lr 5e-4 --lr-scheduler inverse_sqrt --warmup-updates 4000 \
    --dropout 0.3 --weight-decay 0.0001 \
    ...
    --eval-bleu-print-samples \
    --best-checkpoint-metric bleu --maximize-best-checkpoint-metric \
    --save-dir perceiver_deep_1020_REVERSE \
    --save-interval 100 --max-epoch 100 --patience 10
...
fairseq-train \
    ...
    --arch perceiver_deep_encoder \
    --log-file perceiver_deep_log_APPEND_1020.log --tensorboard-logdir perceiver_deep_1020_APPEND \
    --seed 1314 --max-tokens 4096 --find-unused-parameters \
    --optimizer adam --adam-betas '(0.9, 0.98)' --clip-norm 1.0 \
    --lr 5e-4 --lr-scheduler inverse_sqrt --warmup-updates 4000 \
    --dropout 0.3 --weight-decay 0.0001 \
    ...
    --eval-bleu-print-samples \
    --best-checkpoint-metric bleu --maximize-best-checkpoint-metric \
    --save-dir perceiver_deep_1020_APPEND \
    --save-interval 100 --max-epoch 100 --patience 10
...
fairseq-train \
    ...
    --arch perceiver_deep_encoder \
    --log-file perceiver_deep_log_PREPEND_1020.log --tensorboard-logdir perceiver_deep_1020_PREPEND \
    --seed 1314 --max-tokens 4096 --find-unused-parameters\
    --optimizer adam --adam-betas '(0.9, 0.98)' --clip-norm 1.0 \
    --lr 5e-4 --lr-scheduler inverse_sqrt --warmup-updates 4000 \
    --dropout 0.3 --weight-decay 0.0001 \
    ...
    --eval-bleu-print-samples \
    --best-checkpoint-metric bleu --maximize-best-checkpoint-metric \
    --save-dir perceiver_deep_1020_PREPEND \
    --save-interval 100 --max-epoch 100 --patience 10
