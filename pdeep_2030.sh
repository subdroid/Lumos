...
fairseq-train \
    ...
    --log-file perceiver_deep_log_READ_2030.log --tensorboard-logdir perceiver_deep_2030_READ \
    ...
    --save-dir perceiver_deep_2030_READ \
...
fairseq-train \
    ...
    --arch perceiver_deep_encoder \
    --log-file perceiver_deep_log_REVERSE_2030.log --tensorboard-logdir perceiver_deep_2030_REVERSE \
    --seed 1314 --max-tokens 4096 --find-unused-parameters \
    --optimizer adam --adam-betas '(0.9, 0.98)' --clip-norm 1.0 \
    --lr 5e-4 --lr-scheduler inverse_sqrt --warmup-updates 4000 \
    --dropout 0.3 --weight-decay 0.0001 \
    ...
    --eval-bleu-print-samples \
    --best-checkpoint-metric bleu --maximize-best-checkpoint-metric \
    --save-dir perceiver_deep_2030_REVERSE \
    --save-interval 100 --max-epoch 100 --patience 10
...
fairseq-train \
    ...
    --arch perceiver_deep_encoder \
    --log-file perceiver_deep_log_APPEND_2030.log --tensorboard-logdir perceiver_deep_2030_APPEND \
    --seed 1314 --max-tokens 4096 --find-unused-parameters \
    --optimizer adam --adam-betas '(0.9, 0.98)' --clip-norm 1.0 \
    --lr 5e-4 --lr-scheduler inverse_sqrt --warmup-updates 4000 \
    --dropout 0.3 --weight-decay 0.0001 \
    ...
    --eval-bleu-print-samples \
    --best-checkpoint-metric bleu --maximize-best-checkpoint-metric \
    --save-dir perceiver_deep_2030_APPEND \
    --save-interval 100 --max-epoch 100 --patience 10
...
fairseq-train \
    ...
    --arch perceiver_deep_encoder \
    --log-file perceiver_deep_log_PREPEND_2030.log --tensorboard-logdir perceiver_deep_2030_PREPEND \
    --seed 1314 --max-tokens 4096 --find-unused-parameters \
    --optimizer adam --adam-betas '(0.9, 0.98)' --clip-norm 1.0 \
    --lr 5e-4 --lr-scheduler inverse_sqrt --warmup-updates 4000 \
    --dropout 0.3 --weight-decay 0.0001 \
    ...
    --eval-bleu-print-samples \
    --best-checkpoint-metric bleu --maximize-best-checkpoint-metric \
    --save-dir perceiver_deep_2030_PREPEND \
    --save-interval 100 --max-epoch 100 --patience 10
